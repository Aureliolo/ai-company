...
| `cost` | Computed cost in the configured currency (internal base currency from model pricing). The `budget.currency` setting (default EUR) controls display formatting in the dashboard and reports. |
