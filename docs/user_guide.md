...
4. **Create your company** -- name your synthetic organization and optionally start from a template. When a template is selected, agents are auto-created with models matched to your configured providers.
