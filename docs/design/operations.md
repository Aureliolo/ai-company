...
| `/api/v1/agents` | List, hire, fire, modify agents. Sub-routes: `GET /{name}/performance` (metrics summary), `GET /{name}/activity` (paginated timeline), `GET /{name}/history` (career events) |
