...
func TestExtractImageRepo(t *testing.T) {
	tests := []struct {
		...
		{"DHI nats tag + digest", "    image: dhi.io/nats:2.12-debian13@sha256:abc", true, "dhi.io/nats", true, true},
		{"DHI postgres tag-only", "    image: dhi.io/postgres:18-debian13", true, "dhi.io/postgres", true, false},
