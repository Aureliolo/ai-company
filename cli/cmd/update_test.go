...
var updateBoilerplateOnlyCases = []struct {
	...
	},
	{
		...
		existing: "# Generated by SynthOrg CLI 0.7.3-dev.11\nservices:\n  nats:\n    image: dhi.io/nats:2.12-debian13@sha256:45876e0c090615cf847129ace248649d7da79b40c5863b321493e5970e0eec4f\n",
		fresh:    "# Generated by SynthOrg CLI 0.7.3-dev.19\nservices:\n  nats:\n    image: dhi.io/nats:2.12-debian13@sha256:33f3b26c651c15669d50da0d88ccd1fea1f3c9782e38dcf70c4ae1584e9cc5ca\n",
		want:     true,
	},
	{
		name:     "DHI postgres tag bump",
		existing: "# Generated by SynthOrg CLI v0.3.9\nservices:\n  postgres:\n    image: dhi.io/postgres:18-debian13\n",
		fresh:    "# Generated by SynthOrg CLI v0.3.10\nservices:\n  postgres:\n    image: dhi.io/postgres:19-debian13\n",
		want:     true,
	},
	{
		name:     "image repo change rejected",
		existing: "# Generated by SynthOrg CLI v0.3.9\nservices:\n  postgres:\n    image: dhi.io/postgres:18-debian13\n",
		fresh:    "# Generated by SynthOrg CLI v0.3.10\nservices:\n  postgres:\n    image: docker.io/library/postgres:18-debian13\n",
		want:     false,
	},
	{
		name:     "mixed synthorg + DHI bump",
		existing: "# Generated by SynthOrg CLI v0.3.9\nservices:\n  backend:\n    image: ghcr.io/aureliolo/synthorg-backend@sha256:aaa\n  nats:\n    image: dhi.io/nats:2.12-debian13@sha256:bbb\n",
		fresh:    "# Generated by SynthOrg CLI v0.3.10\nservices:\n  backend:\n    image: ghcr.io/aureliolo/synthorg-backend@sha256:ccc\n  nats:\n    image: dhi.io/nats:2.12-debian13@sha256:ddd\n",
		want:     true,
	},
	{
...
func TestExtractImageRepo(t *testing.T) {
	tests := []struct {
		...
		{"synthorg digest", "    image: ghcr.io/aureliolo/synthorg-backend@sha256:abc", true, "ghcr.io/aureliolo/synthorg-backend", true},
		{"synthorg tag", "    image: ghcr.io/aureliolo/synthorg-backend:0.7.3", true, "ghcr.io/aureliolo/synthorg-backend", true},
		{"DHI nats with embedded port-like tag", "    image: dhi.io/nats:2.12-debian13@sha256:abc", true, "dhi.io/nats", true},
		{"DHI postgres tag-only", "    image: dhi.io/postgres:18-debian13", true, "dhi.io/postgres", true},
		{"registry with port", "    image: localhost:5000/synthorg-backend:latest", true, "localhost:5000/synthorg-backend", true},
		{"registry with port and digest", "    image: localhost:5000/synthorg-backend@sha256:abc", true, "localhost:5000/synthorg-backend", true},
		{"registry port differs", "    image: localhost:6000/synthorg-backend:latest", true, "localhost:6000/synthorg-backend", true},
		{"tabs indent", "\timage: ghcr.io/aureliolo/synthorg-backend:0.7.3", true, "ghcr.io/aureliolo/synthorg-backend", true},
		{"trailing comment", "    image: ghcr.io/foo/bar:tag  # pinned", true, "ghcr.io/foo/bar", true},
		{"unpinned image (no tag, no digest)", "    image: ghcr.io/aureliolo/synthorg-backend", true, "ghcr.io/aureliolo/synthorg-backend", false},
		{"unpinned with comment", "    image: dhi.io/nats  # rolling", true, "dhi.io/nats", false},
		{"empty value", "    image:", false, "", false},
		{"missing image keyword", "    foo: bar", false, "", false},
		{"comment line", "# image: ghcr.io/foo:tag", false, "", false},
		{"yaml array reject", "    image: [a, b]", false, "", false},
		{"empty line", "", false, "", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			repo, pinned, ok := extractImageRepo(tt.line)
			if ok != tt.wantOK {
			...
			if pinned != tt.wantPinned {
				t.Errorf("extractImageRepo(%q) pinned = %v, want %v", tt.line, pinned, tt.wantPinned)
			}
		})
	}
}
