...
ORGANIZATION_HANDLERS: dict[str, Any] = {
    ...
    "synthorg_departments_get": _mk("synthorg_departments_get", _WHY_DEPARTMENTS),
    ...
    "synthorg_teams_delete": _mk_destructive("synthorg_teams_delete", _WHY_TEAMS),
