...
INFRASTRUCTURE_HANDLERS: dict[str, Any] = {
    ...
    "synthorg_settings_update": _mk("synthorg_settings_update", _WHY_SETTINGS),
    "synthorg_settings_delete": _mk_destructive(
        "synthorg_settings_delete",
        _WHY_SETTINGS,
    ),
    "synthorg_providers_list": _mk("synthorg_providers_list", _WHY_PROVIDERS),
    "synthorg_providers_get": _mk("synthorg_providers_get", _WHY_PROVIDERS),
    ...
    "synthorg_projects_create": _mk("synthorg_projects_create", _WHY_PROJECTS),
    "synthorg_projects_update": _mk("synthorg_projects_update", _WHY_PROJECTS),
    ...
    "synthorg_requests_create": _mk("synthorg_requests_create", _WHY_REQUESTS),
    "synthorg_setup_get_status": _mk("synthorg_setup_get_status", _WHY_SETUP),
    "synthorg_setup_initialize": _mk("synthorg_setup_initialize", _WHY_SETUP),
