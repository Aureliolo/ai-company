...
export function StatusBar() {
  ...
  return (
    <div className="bg-bg-base border-b border-border px-4 h-8 flex items-center gap-4 shrink-0 text-[11px] tracking-wide font-mono text-text-secondary select-none overflow-hidden">
      ...
      <span className="flex items-center whitespace-nowrap">
        ...
        <span className="ml-1.5" style={{ color: budgetColor }}>
          {company.budgetPercent.toFixed(1)}%
        </span>
