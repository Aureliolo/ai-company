...
const taskTypeColors: Record<string, string> = {
  research: "var(--theme-accent-dim)",
  analysis: "var(--theme-text-secondary)",
  report: "var(--theme-success)",
  development: "var(--theme-accent)",
  review: "var(--theme-danger)",
  operations: "var(--theme-text-muted)",
  design: "var(--theme-warning)",
  outreach: "var(--theme-accent)",
}
