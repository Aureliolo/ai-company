...
<template>
  <div class="space-y-4">
    <div>
      ...
      <p class="mt-2 text-sm text-slate-400 whitespace-pre-wrap">
    ...
    <div
      v-if="Object.keys(approval.metadata).length > 0"
      class="rounded-lg border border-slate-800 p-4"
    >
      ...
      <div
        v-for="(value, key) in approval.metadata"
        :key="key"
