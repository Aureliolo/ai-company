...
export type ApiResponse<T> =
  ...
  | { data: null; error: string; error_detail: ErrorDetail | null; success: false }
...
export type PaginatedResponse<T> =
  ...
  | { data: null; error: string; error_detail: ErrorDetail | null; success: false; pagination: null; degraded_sources?: readonly string[] }
