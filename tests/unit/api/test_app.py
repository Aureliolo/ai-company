...
class TestAppLifecycle:
    async def test_startup_partial_failure_cleanup(
        ...
        with pytest.raises(RuntimeError, match="bus boom"):
            await _safe_startup(persistence, bus, None, None, None, None, app_state)
    ...
    async def test_shutdown_error_handling(self) -> None:
        ...
        await _safe_shutdown(None, None, None, None, None, persistence)
    ...
    async def test_task_engine_failure_cleans_up(
        ...
        with pytest.raises(RuntimeError, match="engine boom"):
            await _safe_startup(persistence, bus, None, None, mock_te, None, app_state)
    ...
    async def test_shutdown_task_engine_failure_does_not_propagate(self) -> None:
        ...
        await _safe_shutdown(mock_te, None, None, None, None, None)
    ...
    async def test_meeting_scheduler_lifecycle(
        ...
        await _safe_shutdown(None, mock_sched, None, None, None, None)
